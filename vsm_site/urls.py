...
urlpatterns = [
    ...
    path('api/v1/detailsfull/', DetailFullInfoViewSet.as_view({'get':'list'})),# возможно ненужны
    path('api/v1/detailsfull/<int:pk>/', DetailFullInfoONEViewSet.as_view({'get':'list'})),

    path('api/v1/orders/', OrderInfoViewSet.as_view({'get':'list'})),
